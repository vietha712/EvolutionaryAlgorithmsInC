...
double func(double *A)
{
    ...
    for (int i = 0; i < NUM_OF_ELEMENTS; i++)
    {
        ...
        multiplyMatrices1D(&Te_Transpose, &ke2x2, &output6x2); //line 59
        multiplyMatrices1D(&output6x2, &Te, &output6x6); // -> ok here
    ...
    deallocateMatrix1D(&output6x2);
    deallocateMatrix1D(&output6x6);
