...
const int gCoord1D[2 * NUM_OF_NODES] = { 0   , 240 , 480 , 720 , 960 , 0   , 120 , 240 , 360 , 480 , 600 , 720 , 840 , 960 , 0   , 240 , 480 , 720 , 960 , 0   , 120 , 240 , 360 , 480 , 600 , 720 , 840 , 960 , 0   , 240 , 480 , 720 , 960 , 0   , 120 , 240 , 360 , 480 , 600 , 720 , 840 , 960 , 0  , 240, 480, 720, 960, 0  , 120, 240, 360, 480, 600, 720, 840, 960, 0  , 240, 480, 720, 960, 0  , 120, 240, 360, 480, 600, 720, 840, 960, 0  , 240, 480, 720, 960, 240, 720,
...
const int element1D[NUM_OF_ELEMENTS * 2] = 
...
const double minStress = -10, maxStress = 10;
...
double func(double *A)
{
    ...
    const int bcDOF[4] = {150, 151, 152, 153};
    double bcValue[4] = {0};
    ...
    for (int i = 0; i < NUM_OF_ELEMENTS; i++)
    {
        ...
        y[1] = gCoord1D[77 + element1D[i * 2 + 1] - 1]; //29 -> 9
